#include "Days.h"
std::string Day7::part1(std::ifstream &inputFile)
{
...
std::string Day7::part2(std::ifstream &inputFile)
{
    util::resetStream(inputFile);
...
Directory *Day7::parseCommands(std::ifstream &inputFile)
{
...
size_t Day7::sum(const Directory &directory)
{
    size_t sizeSum = 0;
