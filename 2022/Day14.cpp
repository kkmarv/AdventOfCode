...
std::string Day14::part1(std::ifstream &inputFile)
{
...
std::string Day14::part2(std::ifstream &inputFile)
{
    const Points rocks       = parseInputFile(inputFile);
 ...
 */
Points Day14::parseInputFile(std::ifstream &inputFile)
{
    Points rocks;
 ...
 */
Points Day14::getPointsBetween(const Vec2 &start, const Vec2 &end) const
{
    Points result;
 ...
 */
void Day14::printScan(const Points &rocks, const Points &sand, const Border &border) const
{
 ...
 */
Points Day14::simulateSandDrops(const Points &rocks, const Border &border, Part part) const
{
    Points sand;
 ...
 */
void Day14::dropSandCorn(Vec2 &sandCorn, const Points &sand, const Points &rocks, const Border &border, Part part) const
{
 ...
 */
bool Day14::isPointFree(const Vec2 &point, const Points &rocks, const Points &sand) const
{
